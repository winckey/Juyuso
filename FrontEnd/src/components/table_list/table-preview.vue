<template>
  <v-dialog
    ...
    width="900"
  >
    <v-card class="p-5 mt-n3">
      <v-card-title class="pt-0 d-flex justify-content-center" style="font-size: 1.5rem">
        테이블 입장 전
      </v-card-title>
      <v-divider></v-divider>
      ...
      <v-card-actions class="mt-5 mb-n5 d-flex justify-content-center">
        <v-btn
          color="#4DB6AC"
          dark
          rounded
