  ...
  methods: {
    ...
    sendMessage() {
      if (this.chatInput.trim()) {
        this.client.send('/publish/chat/message', JSON.stringify({'chatRoomId': this.roomId, 'message': this.chatInput, 'writerName': this.user.nickname,'writerId': this.user.id, 'receiverId': this.chatFriend.id}), {})
      }
      this.chatInput = null
    }
  }
